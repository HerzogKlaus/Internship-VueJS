<template>
  <v-container class="d-flex flex-column">
    ...
    <v-row>
      <v-col cols="12" md="12" sm="12">
        <div
          class="add-client d-flex flex-column flex-lg-row flex-md-row flex-sm-row justify-space-around justify-md-start align-center
          col-lg-10 flex-wrap flex-md-nowrap"
        >
          ...
          <v-btn
            ...
            @click="addClient()"
          >Добавить</v-btn>
          <p class="ma-0 mt-lg-n8 body-2 font-weight-bold mt-md-n9 mt-sm-n8 mt-10 mr-md-12 pr-md-12">или</p>
          <v-btn
            text
            small
